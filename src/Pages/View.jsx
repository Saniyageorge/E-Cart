...
<div className="container mt-5 row ms-5">
        ...
        <Button className='btn btn-outline-dark' onClick={()=>handleWishlist(product)}><i className='fa-solid fa-heart text-danger' ></i></Button>
<Button className='btn btn-outline-dark'><i className='fa-solid fa-cart-plus text-light'></i>Cart</Button>
        </div>
        </div>
        </div>
      </div>
